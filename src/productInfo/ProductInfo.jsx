                    ...
                    <div className="flex flex-wrap mb-24 -mx-4">
                        ...
                        <div className="w-full px-4 md:w-1/2">
                            <div className="lg:pl-20">
                                <div className="mb-4 ">
                                    <h2 className="max-w-xl mb-4 text-xs font-semibold leading-loose tracking-wide text-gray-700 md:text-2xl dark:text-gray-300">
                                ...
                                <div className="mb-4">
                                    <h2 className="mb-2 text-xl font-bold text-gray-700 dark:text-gray-400">
                                        Description :
                                    </h2>
